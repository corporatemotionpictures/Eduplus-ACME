        ...
        let tabs = [
            {
                ...
                content: (
                    <div className="container  ">
                        ...
                        <div className=" mb-5">
                            <button onClick={(e) => this.print(e)} className="btn btn-primary float-right">Print As PDF</button>
                        </div>
                        {
                            this.state.order &&
                            <div className="p-4 mt-5  subpage">
                                ...
                                <div className="row pb-3">
                                    ...
                                    <div className="col-7 float-right text-right">
                                        ...
                                        <p className="text-gray-500 mb-0"> <b>Date:</b> {moment(this.state.order.created_at).format('MMMM Do YYYY, h:mm:ss a')}</p>
                                ...
                                <div className="row py-3">
                                    <div className="col-6">
                                        <b>Ship to:</b>
                                        <p className="text-gray-500 mb-0">{this.state.order.user.first_name} {this.state.order.user.last_name}</p>
                                        <p className="text-gray-500 mb-0">Email : {this.state.order.user.email}</p>
                                        <p className="text-gray-500 mb-0">Mobile Number : {this.state.order.user.mobile_number}</p>
                                        {
                                            <p className="text-gray-500 mb-0">Address : {this.state.order.address ? `${this.state.order.address},` : ''}  {this.state.order.city ? `${this.state.order.city},` : ''}    {this.state.order.state}  {this.state.order.zip_code}, {this.state.order.country}</p>
                                        }
                                        ...
                                        {this.state.invoiceDetails && this.state.invoiceDetails.invoiceFrom && this.state.invoiceDetails.invoiceFrom == 'SHOW' &&
                                            <div className="mt-2">
                                                ...
                                                {this.state.invoiceDetails.invoiceFromEmail && <p className="text-gray-500 mb-0">Email : {this.state.invoiceDetails.invoiceFromEmail}</p>}
                                                {this.state.invoiceDetails.invoiceFromMobile && <p className="text-gray-500 mb-0">Mobile Number : {this.state.invoiceDetails.invoiceFromMobile}</p>}
                                                {this.state.invoiceDetails.invoiceFromGST && <p className="text-gray-500 mb-0">GST : {this.state.invoiceDetails.invoiceFromGST}</p>}
                                                {
                                                    this.state.invoiceDetails.invoiceFromAddress && <p className="text-gray-500 mb-0">Address : {this.state.invoiceDetails.invoiceFromAddress}</p>
                                                }
                                            </div>
                                        }
                                    ...
                                    <div className="col-6 text-right float-right">
                                        ...
                                        <p className="text-gray-500 mb-0">Pay Via : {this.state.order.pay_via}</p>
                                        <p className="text-gray-500 mb-0">Transaction ID : {this.state.order.transaction ? this.state.order.transaction.transaction_id : ''}</p>
                                        <p className="text-gray-500 mb-0">Transaction Status : {this.state.order.transaction ? this.state.order.transaction.status : ''}</p>
                                        <p className="text-gray-500 mb-0">Payment Mode : {this.state.order.transaction ? this.state.order.transaction.payment_mode : ''}</p>
                                        {/* <p className="text-gray-500 mb-0">Order ID : {this.state.order.transaction ? this.state.order.transaction.order_id : ''}</p> */}
                                    </div>
                                </div>
...
">
                                        ...
                                        <tbody>
                                            {this.state.order.carts.map((cart, i) => (
                                                ...
                                                <td className="px-3 py-2 whitespace-nowrap text-right">{cart.quantity}</td> */}
                                                    <td className="px-3 py-2 whitespace-nowrap text-right">
                                                        ₹ {cart.base_price}
                                                        {`${cart.tax_included_in_base_price ? '(Tax Included)' : ''}`}
                                                        <br />
                                                    ...
                                                    <td className="px-3 py-2 whitespace-nowrap text-right">{cart.tax_amount ? (cart.tax_amount_type == 'PERCENT' ? `₹ ${(cart.finalTax)} ( ${cart.tax_amount} %)` : `₹ ${cart.tax_amount}`) : `₹ 0`}</td>
                            ...
                            <div className="p-4 mt-5 container subpage">
                                ...
                                <div className="row py-3">
                                    <div className="col-6">
                                        ...
                                        <p className="text-gray-500 mb-0">Mobile Number : {this.state.order.user.mobile_number}</p>
                                        {
                                            this.state.order.address && <p className="text-gray-500 mb-0">Address : {this.state.order.address},  {this.state.order.city},  {this.state.order.state}  {this.state.order.zip_code}, {this.state.order.country}</p>
                                        }
