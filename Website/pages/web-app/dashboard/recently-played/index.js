        ...
        <div className="container">
          <div className="row">
            <div className={'col-sm-12'}>
              <h3 className="font-bold"><i class="fa fa-play-circle mr-2" aria-hidden="true"></i>Recently Played</h3>
              ...
              <div className="row">

                {
                        ...
                        <div className="single-courses">
                          <div className="courses_banner_wrapper">
                            <div className="courses_banner">
                              <Link href={`/web-app/dashboard/recently-played/[slug]`} as={`/web-app/dashboard/recently-played/${video.id}`}>
                  ...
                  <div className="empty_box">
                    ...
                    <h5 className="text-center"> <b className="font-saffron"><b></b></b>No videos found on recently played.</h5>
                  </div>
                }
