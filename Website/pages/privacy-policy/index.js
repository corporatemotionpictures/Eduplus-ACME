...
export default function privacyPolicy() {
  return (
    <>
      ...
      {/* MId Content starts */}
      <section className="about_us about_spaced">
        <div className="container">

          <div className="about_title mb-2">
            <span>{window.localStorage.getItem('baseTitle')}</span>
            <h2>Privacy Policy</h2>
          </div>

          <div className="about_content_wrapper">
            <div className="privacy_space">

              <p>At www.acme.in, accessible from www.acme.in, one of
              our main priorities is the privacy of our visitors. This Privacy
              Policy document contains types of information that is collected
  and recorded by www.acme.in and how we use it.</p>

              <p>If you have additional questions or require more information
  about our Privacy Policy, do not hesitate to contact us.</p>

              <p>This Privacy Policy applies only to our online activities and
              is valid for visitors to our website with regards to the
              information that they shared and/or collect in www.acme.in.
  ...
  information.</p>
              <p>If you contact us directly, we may receive additional
  ...
  to:</p>
    ...
    marketing and promotional purposes</li>
              ...
              <p>www.acme.in follows a standard procedure of using log
  ...
  demographic information.</p>
              ...
              <h4>Advertising Partners Privacy Policies
</h4>

              <p>You may consult this list to find the Privacy Policy for each
  of the advertising partners of www.acme.in.</p>
              ...
              www.acme.in, which are sent directly to users' browser.
  ...
  advertising content that you see on websites that you visit.</p>
              ...
              <p>Note that www.acme.in has no access to or control over
  these cookies that are used by third-party advertisers.</p>

              <h4>Third Party Privacy Policies</h4>

              <p>www.acme.in's Privacy Policy does not apply to other
  ...
  browsers' respective websites.</p>
              ...
              <h4>CCPA Privacy Rights (Do Not Sell My
  Personal Information)</h4>

              <p>Under the CCPA, among other rights, California consumers have
  the right to:</p>
              <p>Request that a business that collects a consumer's personal
              data disclose the categories and specific pieces of personal
  data that a business has collected about consumers.</p>
              <p>Request that a business delete any personal data about the
  consumer that a business has collected.</p>
              <p>Request that a business that sells a consumer's personal data,
  not sell the consumer's personal data.</p>
              <p>If you make a request, we have one month to respond to you. If
  ...
  believe is incomplete.</p>
              <p>The right to erasure – You have the right to request that we
  ...
  under certain conditions.</p>
              <p>The right to object to processing – You have the right to
  ...
  activity.</p>
              ...
              <p>www.acme.in does not knowingly collect any Personal
