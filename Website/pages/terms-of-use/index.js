  ...
  return (
    <>
      {/* <header className="header_inner courses_page">
        <div className="intro_wrapper terms_head">
                ...
                <div className="intro_text">
                  ...
                  <div className="pages_links">
                    ...
                    <Link href="/terms-conditions">
                      <a title="" className="active">Terms of Use</a>
                    </Link>
                  </div>
                </div>
              </div>
      ...
      <section className="about_us about_spaced">
        <div className="container">
          ...
          <div className="about_content_wrapper">
            <div class="privacy_space">

              <p>The www.acme.in website located at www.acme.in is a copyrighted work belonging to {window.localStorage.getItem('baseTitle')}. Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features.</p>
              ...
              <p><strong>Notice Requirement and Informal Dispute Resolution.</strong> Before either party may seek arbitration, the party must first send to the other party a written Notice of Dispute describing the nature and basis of the claim or dispute, and the requested relief.&nbsp; A Notice to the Company should be sent to: Usha Complex, General Mahadev Singh Road, Near Ballupur Chowk, Dehradun, Uttarakhand - 248001. After the Notice is received, you and the Company may attempt to resolve the claim or dispute informally.&nbsp; If you and the Company do not resolve the claim or dispute within thirty (30) days after the Notice is received, either party may begin an arbitration proceeding.&nbsp; The amount of any settlement offer made by any party may not be disclosed to the arbitrator until after the arbitrator has determined the amount of the award to which either party is entitled.</p>
              ...
              <p>Address: ACME Academy, 3rd Floor, Chouhan Complex, Near Bank of Baroda, opposite of Rajkumar College, G.E. Road, Raipur </p>
              <p>Email:  acmeacademy2016@gmail.com</p>
            </div>
          </div>
