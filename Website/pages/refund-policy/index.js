            ...
            <section className="about_us about_spaced">
                <div className="container">
                    ...
                    <div className="about_content_wrapper">
                        <div className="refund_space">


                            <p>Last updated: March 08, 2021</p>
                            <p>Thank you for shopping at {window.localStorage.getItem('baseTitle')}.</p>
                            ...
                            <ul>
                                <li>
                                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to {window.localStorage.getItem('baseTitle')}.</p>
                                </li>
                                <li>
                                ...
                                <li>
                                    <p><strong>Website</strong> refers to {window.localStorage.getItem('baseTitle')}, accessible from <a href="https://acme.in/" rel="external nofollow noopener" target="_blank">https://acme.in/</a></p>
                                </li>
                                <li>
                            ...
                            <ul>
                                <li>By phone number: +91- 7714090352, 8109977628, 9516001679</li>
                            </ul>
                            ...
                            <p>{window.localStorage.getItem('baseTitle')}, 3rd Floor, Chouhan Complex, Near Bank of Baroda,<br />opposite of Rajkumar College, G.E. Road, Raipur</p>
