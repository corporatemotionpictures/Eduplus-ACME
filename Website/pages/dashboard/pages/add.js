...
export default class extends Component {
  ...
  buildAddModel = () => {
    ...
    this.setState({
      displayModelTitle: `Add ${this.state.baseTitle} Information And Publish`
    })
    ...
    let items = {
      'title': {
        ...
        onTab: 1,
        defaultValue: document.getElementById(`pageTitleInput`) ? document.getElementById(`pageTitleInput`).value : null
      },
      'visibility': {
  ...
  componentDidMount() {
    ...
    if (document.getElementById('rootSection') != undefined) {
      ...
      <>
        ...
        <div className="row border-bottom">
          ...
          <div className="button-submit bg-white col-5 offset-1  pl-5">
            <input type="text" className=" border-bottom-2 form-control border-top-0 border-left-0 border-right-0 mt-3 ml-5 w-75 title-input" id="pageTitleInput" placeholder="Page Title" />
          </div>
          ...
          <div className="button-submit bg-white col-3 "><button className="my-2" onClick={() => this.changeModalStatus()}>Add Information And Publish</button></div>
  ...
  <IconBI.BiFontColor size={18} />
                      ...
                      <div className="col p-2 text-white d-flex">
                        <IconBI.BiColorFill size={18} onClick={() => {
  ...
  <IconGI.GiResize size={18} />
                  ...
                  <Import editable="true" sectionID={`${preSection.section_id}`} position={`${preSection.position}`} inputTypes={inputTypes} />                                </div>
              </>

            })}
          </div>

          {/* <div className="button-submit bg-white"><button className="my-2" onClick={() => this.changeModalStatus()}>Save Page</button></div> */}
        </div>
