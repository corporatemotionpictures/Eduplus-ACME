...
export default class extends Component {
  state = {
    ...
    filters: {
      limit: 10,
      offset: 0,
      whereNotIn:['SplashScreen', 'metaDetails', 'contacts', 'dynamicVideos']
    },
  ...
  render() {
    ...
    this.state.settings && Object.values(this.state.settings).map((setting, index) => {
      let data = {
        ...
        content: (
          <div className="sm:px-4 w-full mt-3 md:mt-0">
      ...
      <>
        ...
        <Widget
          ...
          {screen.width > 767 &&<div className="hidden lg:block">
            <VerticalTabs tabs={settingsData} />
          </div>}
