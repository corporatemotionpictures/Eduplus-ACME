      ...
      {items.map((item, i) => (
        <button
          ...
          className={`btn btn-default btn-outlined bg-transparent ${
            i === openTab
              ? 'text-base hover:text-blue-700 border-blue-500 hover:border-blue-700'
              : 'text-base hover:text-blue-700 border-blue-500 hover:border-blue-700'
          }`}>
          {item.title}
        </button>
      ...
      {items.map((item, i) => (
        <button
          ...
          className={`btn btn-circle ${
            i === openTab
              ? 'bg-base hover:bg-blue-600 text-white'
      ...
      {items.map((item, i) => (
        <button
          ...
          className={`btn btn-default btn-rounded btn-outlined btn-icon ${
            i === openTab ? 
    "bg-transparent text-base hover:text-blue-700 border-blue-500 hover:border-blue-700" :
    "bg-transparent text-base hover:text-blue-700 border-blue-500 hover:border-blue-700"
          } `}>
