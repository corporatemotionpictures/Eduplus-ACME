        ...
        <div className="flex items-center justify-center">
          <div className="flex-shrink-0 w-24">
            <img
              ...
              alt={user.name}
              className="rounded-full h-24 w-24 ring user-img"
            />
          </div>
          <div className="ml-4 w-full">
            <div className="font-regular text-xs text-gray-500 uppercase">
              Members
            </div>
            <div className="text-lg font-bold">{user.name}</div>
          </div>
          <div className="hidden lg:flex flex-shrink-0 space-x-2">
            <button className="btn btn-default btn-rounded bg-base hover:bg-blue-600 text-white">
              Subscribe
            </button>
            <button className="btn btn-default btn-rounded bg-base hover:bg-blue-600 text-white">
              Follow
