...
export default class OTSLoader extends Component {
  ...
  render() {
    return (
      <View style={{backgroundColor:BG_COLOR,justifyContent:'center',alignItems:'center',flex:1}}>
        <LottieView 
        autoPlay
        ...
        <View style={{position:'absolute',top:0,left:0,right:0,bottom:0,justifyContent:'center',alignItems:'center'}}>
            <Text style={{fontFamily:'Roboto-Regular', color:"white",marginTop:200}}> Starting Online Test</Text>
            <Text style={{fontFamily:'Roboto-Regular', color:"white"}}>Analyzing your Strengths and Weaknesses  </Text>
        </View>
      </View>
    );
  }
